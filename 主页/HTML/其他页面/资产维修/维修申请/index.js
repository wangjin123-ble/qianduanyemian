...
function main()
{
    var NowNum = document.getElementById("edit-1").value.length;
    
    // var NowNum = document.getElementById("edit-2").value.length;
    if(NowNum>10)
{
    alter1();
}
...
function alter2()
{
    document.getElementById("alter2").style.display="block";
}
function main1()
{
