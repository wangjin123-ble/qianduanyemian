...
function mainbord0(){
    ...
    if(bordvalue==""||bordvalue==" 请输入手机号码"||bordvalue=="该账号不存在")
    {
...
function reback(){
    ...
    document.getElementById("first-form").value=" 请输入手机号码";
}
function reback1()
        ...
        function()
{
    ...
    // document.getElementById("time-2").style.display="block";
    var time=30;
    var p=document.getElementById("timing");
